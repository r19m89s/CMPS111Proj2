...
_PROTOTYPE( int do_printmessage, ()					);
...
/* sem.c */
_PROTOTYPE( int do_seminit, ()	                			);
_PROTOTYPE( int do_semvalue, ()         					);
_PROTOTYPE( int do_semup, ()	            				);
_PROTOTYPE( int do_semdown, ()	            				);
_PROTOTYPE( int do_semfree, ()	            				);
